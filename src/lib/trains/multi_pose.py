  ...
  def forward(self, outputs, batch):
    ...
    for s in range(opt.num_stacks):
      ...
      if opt.dense_hp:
        ...
        # {'hps': kps, 'hps_mask': kps_mask} kps:  vertex coordinate from 2d_center with no               # gaussian hps_mask:mark this vertex in meaning 第几个物体的第几号关键点
        # hp_loss: vertex_coordinate_loss
